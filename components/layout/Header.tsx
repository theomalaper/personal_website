  ...
  return (
    <header className="sticky top-0 z-50 border-b border-stone-800 bg-stone-950/90 backdrop-blur-sm">
      <div className="max-w-2xl mx-auto px-6 h-14 flex items-center justify-between">
        <Link
          href="/"
          className="font-mono text-sm text-stone-300 hover:text-orange-400 transition-colors"
        >
          portfolio
        </Link>
        ...
        <button
          ...
          className="md:hidden text-stone-400 hover:text-orange-400 transition-colors"
